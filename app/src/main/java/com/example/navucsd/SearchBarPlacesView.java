...
public class SearchBarPlacesView extends ArrayAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        TextView nameText = rowView.findViewById(R.id.NameOfThePlace);
        TextView avaiText = rowView.findViewById(R.id.availability);
        TextView distanceText = rowView.findViewById(R.id.distance);
